<template>
    <div class="bugs">
        ...
        <el-table
            ...
            <el-table-column label="添加时间" width="200" prop="t_date" sortable header-align="center" align="center">
            ...
            <el-table-column label="俱乐部ID" width="500" min-width="180" header-align="center" prop="t_title">
            </el-table-column>

            <el-table-column label="添加人数" width="500" min-width="180" header-align="center" prop="t_link" >
                <template slot-scope="scope">
...
<script>
    ...
    import Addknowledge from './add_people'
    export default {
        components:{
            Addknowledge,
        },
