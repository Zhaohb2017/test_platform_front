...
<!--            </el-table-column>-->
            ...
            <el-table-column label="IP" width="180" min-width="180" header-align="center" prop="t_ip">
            </el-table-column>

            <el-table-column label="port" width="500" min-width="180" header-align="center" prop="t_port" >
            </el-table-column>
