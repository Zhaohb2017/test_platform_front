<template>
    <div class="bugs">
        ...
        <el-table
            ...
            <el-table-column label="版本名称" width="500" min-width="180" header-align="center" prop="t_title">
            </el-table-column>
            ...
            <el-table-column label="版本说明" width="500" min-width="180" header-align="center" prop="t_remark">
            </el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            getKnowledgeList(){
                ...
                axios({
                    method:'get',
                    url:'/api/versions/versions_list',
                }).then(function(resp){
