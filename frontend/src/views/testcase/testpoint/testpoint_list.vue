<template>
  <div class="bugs">
    ...
    <div class="head">
      ...
      <el-input type="text" prefix-icon="el-icon-search" required style="width:270px;" v-model="search_data" placeholder="支持版本，版本，测试点，状态搜索"></el-input>
    ...
    <el-table
      ...
      <el-table-column label="入库状态" width="100" align="center" prop="">
      </el-table-column>

      <el-table-column label="是否失效" width="100" align="center" prop="">
      </el-table-column>
...
<script>
  ...
  import Edit from './testpoint_edit'
  ...
  export default {
    ...
    mounted: function(){
      ...
      console.log('删除按钮：',this.delete_btn);
    },
    ...
    methods: {
      ...
      getBugsList(){
        ...
        axios({
          ...
          for(var i in that.showPointData){
            that.showPointData[i]["t_date"] = timeFormat(that.showPointData[i]["t_date"]);
          }
