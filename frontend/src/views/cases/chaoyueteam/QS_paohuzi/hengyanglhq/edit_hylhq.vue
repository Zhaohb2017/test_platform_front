                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>抽牌：</span>
                                <el-radio v-model="editCaseForm.c_option.o_chou_card" label='20'>抽牌20张</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_chou_card" label='10'>抽牌10张</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_chou_card" label='0'>不抽底牌</el-radio>
                            </template>
                        </div>
                        ...
                        <div v-show="doublePlusNewShowFlag">
                            ...
                            <template>
                                ...
                                <span>请设置新的翻倍数：</span>
                                <el-radio-group v-model="editCaseForm.c_option.o_double_plus_score" >
                                    <el-radio :label=2>翻2倍</el-radio>
                                    <el-radio :label=3>翻3倍</el-radio>
                                    <el-radio :label=4>翻4倍</el-radio>
                                </el-radio-group>
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>选择张数:</span>
                                <el-radio v-model="editCaseForm.c_option.o_cards_num" label='21张'>21张</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_cards_num" label='15张'>15张</el-radio>
                            </template>
                        ...
                        <div>
                            <template>
                                <span>请选择翻醒：</span>
                                <el-radio v-model="editCaseForm.c_option.o_fanxing" label='不带醒'>不带醒</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fanxing" label='翻醒'>翻醒</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fanxing" label='随醒'>随醒</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                        ...
                        <div>
                            <template>
                                <span>默认玩法选项：</span>
                                <el-radio v-model="editCaseForm.c_option.o_tunshu" label='3息1囤'>3息1囤</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_tunshu" label='1息1囤'>1息1囤</el-radio>
                            </template>
                            <template>
                                <el-radio v-model="editCaseForm.c_option.o_qihu" label="6息起胡">6息起胡</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_qihu" label="9息起胡">9息起胡</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_qihu" label="15息起胡">15息起胡</el-radio>
                            </template>
                            <template>
                                <el-radio v-model="editCaseForm.c_option.o_hu_pao" label='有胡必胡'>有胡必胡</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_hu_pao" label='点炮必胡'>点炮必胡</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>请选择玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_mingwei" :label=512>明偎</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_difen" :label=512>底分2分</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_yiwushi" :label=512>一五十</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_red_black" :label=512>红黑点</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_hu_public" :label=512>可胡示众牌</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_piaohu" :label=512>飘胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_tdhdh" :label=512>天地海底胡</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>请选择封顶:</span>
                                <el-radio v-model="editCaseForm.c_option.o_fengding" label='不封顶'>不封顶</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fengding" label='单局30封顶'>单局30封顶</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fengding" label='单局60封顶'>单局60封顶</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fengding" label='单局90封顶'>单局90封顶</el-radio>
                            </template>
                        </div>
                    </el-card>
                </el-form-item>
