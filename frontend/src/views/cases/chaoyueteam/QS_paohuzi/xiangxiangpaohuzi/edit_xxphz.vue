                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_duoble_hint" :label=1>总结算翻倍提示</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_datuo" :label=2>打坨</el-checkbox>
                            </template>
                        </div>
