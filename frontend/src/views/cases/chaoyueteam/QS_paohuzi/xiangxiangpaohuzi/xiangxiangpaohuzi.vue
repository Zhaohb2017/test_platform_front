<template>
    <div class="bugs">
        ...
        <el-table
            ...
            <el-table-column label="用户mid" width="120" prop="c_user" header-align="center" align="center">
                <template slot-scope="scope">
            ...
            <el-table-column label="操作步骤" width="200" min-width="180" header-align="center" prop="c_step">
                <template slot-scope="scope">
...
<script>
    ...
    import AddBugs from './add_xxphz'
    import EditBugs from './edit_xxphz'
