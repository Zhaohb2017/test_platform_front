                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_duoble_hint" :label=1>总结算翻倍提示</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_datuo" :label=2>打坨</el-checkbox>
                            </template>
                        </div>


                    <!--   3人玩法选项   -->
                        <div v-show="threePeople">
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_datuo" :label=2>打坨</el-checkbox>
                            </template>
