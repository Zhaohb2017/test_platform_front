                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>抽牌玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_choupai" label='抽牌20张'>抽牌20张</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_choupai" label='None'>不抽底牌</el-radio>
                            </template>
                        </div>
                        <div v-show="ShowFlag">
                            <template>
                                <span>请选择封顶：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_huxi" :label=100>100息</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_huxi" :label=200>200息</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_huxi" :label=400>400息</el-radio>
                            </template>
                        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getIntegral(vul){
                if(vul==2){
                    this.fanbei_ShowFlag = true;
                }else {
                    this.fanbei_ShowFlag = false;
                }
            },
