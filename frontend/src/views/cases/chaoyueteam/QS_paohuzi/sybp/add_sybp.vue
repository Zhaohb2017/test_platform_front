      ...
      :visible="true">
        ...
        <el-form ref="AddCaseForm" :model="AddCaseForm" :rules='addrules' label-width="80px">
          ...
          <el-form-item label="用户mid" prop="c_mid">
            <el-input type="text" placeholder="输入用户mid" v-model="AddCaseForm.c_mid"></el-input>
          </el-form-item>
          ...
          <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                <el-card class="box-card">
                    ...
                    <div>
                        <template>
                            <span>玩法：</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_RedAndBlack" :label=512>红黑点</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_lianzhuang" :label=512>可连庄</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_0fen" :label=512>0分上告封顶</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_jiachui" :label=512>加锤</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_NoShow_dipai" :label=512>不显底牌</el-checkbox>
                        </template>
                    </div>

                    <div v-show="AddCaseForm.c_options.o_lianzhuang">
                        <template>
                            <span>封顶：</span>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="">不封顶</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="100">100息</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="150">150息</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="200">200息</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="250">250息</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengdinghuxi" label="300">300息</el-radio>
                        </template>
                    </div>
      ...
      return {
        ...
        AddCaseForm: {
          ...
          c_options: {
              ...
              o_huyideng: '5息一囤',
              o_card_num: '抽牌20张',
              o_RedAndBlack: true, //红黑点
              o_lianzhuang:false,   //可连庄
              o_0fen:false,       //0分上告
              o_jiachui: false,   //加锤
              o_integral: '',
              o_NoShow_dipai:false, //不显示底牌
              o_fengdinghuxi:"",    //封顶胡息
              o_double:"",           //加倍
              o_fanbei:"",          //翻倍数据
