                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_RedAndBlack" :label=512>红黑点</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_lianzhuang" :label=512>可连庄</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_0fen" :label=512>0分上告封顶</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_jiachui" :label=512>加锤</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_NoShow_dipai" :label=512>不显底牌</el-checkbox>
                            </template>
                        </div>
                            ...
                            <el-table-column prop="user" label="玩家" style="width:6vw;" >
                                <template slot-scope="scope">
                                    <el-select v-model="scope.row.users" clearable  >
                                        <el-option
                                                v-for="item in users.slice(0,editCaseForm.c_option.o_player)"
                                                :key="item.value"
                                                :label="item.text"
                                                :value="item.value">
                                        </el-option>
