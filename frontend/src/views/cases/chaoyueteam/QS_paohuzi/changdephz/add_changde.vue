                    ...
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                ...
                                <el-checkbox v-model="AddCaseForm.c_options.o_datuanyuan" :label=2>大团圆</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_xingxingxi" :label=2>行行息</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_shuahou" :label=2>耍猴</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_tinghu" :label=2>听胡</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_huangfanDouble" :label=2>黄番2倍</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_jiaxingxing" :label=2>假行行</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_siqihong" :label=2>四七红</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_yikuaibian" :label=2>一块匾</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
