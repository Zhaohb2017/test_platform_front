                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio-group v-model="AddCaseForm.c_options.o_zhongzhuang" >
                        ...
                        <div>
                            <template>
                                <span>局数：</span>
                                <el-radio-group v-model="AddCaseForm.c_options.o_jushu" >
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio-group v-model="AddCaseForm.c_options.o_wanfa">
