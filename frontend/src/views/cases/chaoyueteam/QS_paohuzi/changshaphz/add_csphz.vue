                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>起胡：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_qihu" :label=15>15息起胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_qihu" :label=9>9息起胡</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>选番：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_fanshu" label='5番'>5番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_fanshu" label='10番'>10番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_fanshu" label='不限番'>不限番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_fanshu" label='单局200封顶'>单局200封顶</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_fanshu" label='单局300封顶'>单局300封顶</el-radio>
                        ...
                        <div>
                            <template>
                                <span>自摸选项：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_zimo" :label=1>自摸翻倍</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zimo" :label=2>自摸2番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zimo" :label=3>自摸2分</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>红胡选项：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_honghu" label='红胡2加红加番'>红胡2加红加番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_honghu" label='红胡2十三红5'>红胡2十三红5</el-radio>
                        ...
                        <div>
                            <template>
                                <span>十八小选项：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_shiba" label='十八小5加小番'>十八小5加小番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_shiba" label='十八小5'>十八小5</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_shiba" label='无十八小'>无十八小</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_shiba" label='十六小5'>十六小5</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>十八大选项：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_shibada" label='十八大5大加番'>十八大5大加番</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_shibada" label='十八大5'>十八大5</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_shibada" label='无十八大'>无十八大</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>扎鸟：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_zhaniao" :label=1>扎鸟2分</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zhaniao" :label=2>扎鸟3分</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zhaniao" :label=3>扎鸟5分</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zhaniao" :label=0>无</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_yiwushi" label=1>一五十</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_mingwei" label=2>明偎</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_shuahou" label=3>耍猴</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_haidi"   label=4>海底</el-checkbox>
                            </template>
                        </div>
            ...
            return {
                ...
                AddCaseForm: {
                    ...
                    c_options: {
                        ...
                        o_fanshu:"5番",   //番数
                        o_zimo:1,     //自摸选项
                        o_honghu:"红胡2加红加番",   //红胡选项
                        o_shiba:"十八小5加小番",    //十八小选项
                        o_shibada:"十八大5大加番",    //十八大选项
                        o_zhaniao:1,  //扎鸟选项
                        o_round: 10,
                        roomTypeVuale:"普通创房",
                        clubRoomTypeVuale:'',
