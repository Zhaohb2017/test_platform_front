                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div >
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="editCaseForm.c_option.o_dianpao_hu" :label=1>点炮必胡</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_dianpao_hu" :label=0>无</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>默认选择玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_jszs" :label=512>举手做声</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bdwh" :label=512>不带无胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bdydh" :label=512>不带一点红</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_yxqp" :label=512>运行弃牌</el-checkbox>
                            </template>
                        </div>
