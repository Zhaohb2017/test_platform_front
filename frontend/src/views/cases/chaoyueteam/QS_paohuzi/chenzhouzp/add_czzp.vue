                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div v-show="ShowFlag">
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_qihu" :label=3>3息起胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_qihu" :label=6>6息起胡</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_tun" :label=3>3息一囤</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_tun" :label=1>1息一囤</el-radio>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>请选择玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_zomoDouble" :label=512>自摸翻倍</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_redBlack" :label=512>红黑点</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_maohu" :label=512>毛胡</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>选择玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_dinapaobihu" :label=0>无</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_dinapaobihu" :label=1>点炮必胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_dinapaobihu" :label=2>有炮必胡</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
    ...
    export default {
        ...
        methods: {
            ...
            getValue(val){
                if(val==4){
                    this.ShowFlag = true;
                    this.ThreeShowFlag = false;
                }
                if(val == 3){
                    this.ThreeShowFlag = true;
                    this.ShowFlag = false;
                }
            },
            // 加倍选项判断
