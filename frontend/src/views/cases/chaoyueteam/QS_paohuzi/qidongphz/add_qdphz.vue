                    ...
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                ...
                                <el-radio v-model="AddCaseForm.c_options.o_hu_15" :label=1>15胡起胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_tun_3" :label=1>3息一囤</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                        ...
                        <div>
                            <template>
                                <span>默认选择玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_zimodouble" :label=512>自摸翻倍</el-checkbox>
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" :label=0>无</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" :label=1>有胡必胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" :label=2>点炮必胡</el-radio>
                            </template>
                        </div>
