                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_player" label='3'>3人</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_hu_15" label='15胡起胡'>15胡起胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_tun_3" label='3息一囤'>3息一囤</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                        ...
                        <div>
                            <template>
                                <span>默认选择玩法：</span>
                                <el-checkbox v-model="AddCaseForm.c_options.o_wanfa1" :label=512>自摸翻倍</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_wanfa2" :label=512>底分2分</el-checkbox>
                                <el-checkbox v-model="AddCaseForm.c_options.o_wanfa3" :label=512>红黑点</el-checkbox>
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" label=''>无</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" label='有胡必胡'>有胡必胡</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_bihu" label='点炮必胡'>点炮必胡</el-radio>
                            </template>
                        </div>
