                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_qianghu" :label=1>抢胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_hu_15" :label=2>15息自摸可胡</el-checkbox>
                        ...
                        <div >
                            <template>
                                ...
                                <el-radio v-model="editCaseForm.c_option.o_jushu" :label=8>8局</el-radio>
        ...
        methods: {
            ...
            double(val){
                if(val==1){
                    ...
                    this.doublePlusNewShowFlag = false;
                    this.doublePlusNewShowFlag = false;
                    this.editCaseForm.c_options.o_double_plus_new = 0;
                }
            },
