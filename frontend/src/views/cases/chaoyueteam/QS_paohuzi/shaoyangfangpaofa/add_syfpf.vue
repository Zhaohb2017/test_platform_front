        ...
        <el-dialog
            ...
            <el-form ref="AddCaseForm" :model="AddCaseForm" :rules='addrules' label-width="80px">
                ...
                <el-form-item label="用户mid" prop="c_mid">
                    <el-input type="text" placeholder="用户mid" v-model="AddCaseForm.c_mid"></el-input>
                </el-form-item>
                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_zimodouble" label='自摸翻倍'>自摸翻倍</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_zimodouble" label='自摸加10胡'>自摸加10胡</el-radio>
