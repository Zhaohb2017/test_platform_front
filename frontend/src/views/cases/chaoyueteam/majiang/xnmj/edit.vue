                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>抓鸟：</span>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=2>2鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=3>3鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=4>4鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=6>6鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=8>8鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" label='不扎'>不抓鸟</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                ...
                                <el-checkbox v-model="editCaseForm.c_option.o_chi" :label=1>可以吃</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_choupai" :label=1>随机抽40张牌</el-checkbox>
                        ...
                        <div v-show="showjiaochui">
                            <template>
                                <span>请选择玩法</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_lianchui" :label=1 @change="lianchui">连锤</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bankerchui" :label=1 @change="bankerchui" >庄上锤</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bichui" :label=1 @change="bichui">必锤</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span> 请选择玩法</span>
                                <el-radio v-model="editCaseForm.c_option.o_saizi" :label=3>甩骰+(3)</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_saizi" :label=6>甩骰+(6)</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_saizi" :label=9>甩骰+(9)</el-radio>
                            </template>
                        </div>
                        <div v-show="ShowFlag">
                            <template>
        ...
        methods: {
            ...
            jiachui(val){
                if(val==true){
                    ...
                    this.editCaseForm.c_option.o_bankerchui =false;
                    this.editCaseForm.c_option.o_bichui =false;
