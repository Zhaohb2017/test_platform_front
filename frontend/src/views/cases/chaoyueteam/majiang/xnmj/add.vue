          ...
          <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                <el-card class="box-card">
                    ...
                    <div>
                        <template>
                            <span>抓鸟：</span>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" :label=2>2鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" :label=3>3鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" :label=4>4鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" :label=6>6鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" :label=8>8鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaMa" label='不扎'>不抓鸟</el-radio>
                        </template>
                    </div>
                    <div>
                        <template>
                            <span>玩法：</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_daifeng" :label=1>带风</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_chi" :label=1>可以吃</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_choupai" :label=1>随机抽40张牌</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_jiachui" :label=1 @change="jiachui">加锤</el-checkbox>

                        </template>
                    </div>


                    <div v-show="showjiaochui">
                        <template>
                            <span>请选择玩法</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_lianchui" :label=1 @change="lianchui">连锤</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_bankerchui" :label=1 @change="bankerchui" >庄上锤</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_bichui" :label=1 @change="bichui">必锤</el-checkbox>
                        </template>
                    </div>
                    <div>
                        <template>
                            <span> 请选择玩法</span>
                            <el-radio v-model="AddCaseForm.c_options.o_saizi" :label=3>甩骰+(3)</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_saizi" :label=6>甩骰+(6)</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_saizi" :label=9>甩骰+(9)</el-radio>
                        </template>
                    </div>
                    <div v-show="ShowFlag">
                        <template>
      ...
      handleChange(){
        ...
        jiachui(val){
            if(val==true){
                ...
                this.AddCaseForm.c_options.o_lianchui =false;
                this.AddCaseForm.c_options.o_bankerchui =false;
                this.AddCaseForm.c_options.o_bichui =false;
