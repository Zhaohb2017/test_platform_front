                ...
                <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_option">
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-radio v-model="editCaseForm.c_option.o_zimohu" label='可抢杠胡'>自摸胡(可抢杠胡)</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zimohu" label='不可抢杠胡'>自摸胡(不可抢杠胡)</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zimohu" label='点炮胡'>点炮胡</el-radio>
                                <el-checkbox v-model="editCaseForm.c_option.o_sevenPair" :label=1>可胡7对</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_zhongMa" :label=1>159中码</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_piaofen" :label=1>飘分</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_eighthongzhong" :label=1>八红中</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_kejiepao" :label=1>无红中可接炮</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>选择加码：</span>
                                <el-radio v-model="editCaseForm.c_option.o_jiama" label='不加码'>无红中不加码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_jiama" label='加1码'>无红中加1码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_jiama" label='加2码'>无红中加2码</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>抓鸟：</span>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=2>扎2码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=3>扎3码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=4>扎4码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=6>扎6码</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" label='all'>一码全中</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" label='不扎'>不扎码</el-radio>
                            </template>
                        </div>
    ...
    export default {
        ...
        mounted() {
            if(this.current_data){
                ...
                console.log(22222222222222222222222222,this.editCaseForm);
