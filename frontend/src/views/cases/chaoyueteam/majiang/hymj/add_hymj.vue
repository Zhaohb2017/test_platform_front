          ...
          <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                <el-card class="box-card">
                    ...
                    <div>
                        <template>
                            <span>请选择玩法：</span>
                                <el-radio v-model="AddCaseForm.c_options.o_yao" :label=1>摇一张</el-radio>
                                <el-radio v-model="AddCaseForm.c_options.o_yao" :label=2>摇二张</el-radio>
                    ...
                    <div>
                        <template>
                            <span>抓鸟：</span>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaNiao" :label=1>抓1鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaNiao" :label=2>抓2鸟</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_zhuaNiao" :label=3>抓3鸟</el-radio>
                        </template>
                    </div>
                    <div>
                        <template>
                            <span>玩法：</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_quanrenqiu" :label=1>全人求</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_douzhuang" :label=1>斗 庄</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_choupai" :label=1 v-show="ShowFlag">随机抽40张牌</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_bankerZhuaNiao" :label=1 v-show="ShowFlag">庄家抓鸟</el-checkbox>
    ...
    methods: {
      ...
      getValue(val){
          if(val==2){
              ...
              this.ShowFlag = false;
              this.AddCaseForm.c_options.o_choupai =false;
              this.AddCaseForm.c_options.o_bankerZhuaNiao =false;
              this.doublePlusNewShowFlag = false;
              this.doubleShowFlag = false;
