          ...
          <el-form-item label="创房选项" width="290" min-width="180" header-align="center" prop="c_options">
                <el-card class="box-card">
                    ...
                    <div>
                        <template>
                            <span>玩法：</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_qingyisechi" :label=1 @change="qingyise">清一色可以吃</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_chi" :label=1 @change="Onchi">可以吃</el-checkbox>
                        </template>
                    </div>
                    <div>
                        <template>
                            ...
                            <el-checkbox v-model="AddCaseForm.c_options.o_lianchui" :label=1 v-show="showjiaochui">连锤</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_choupai" :label=1 v-show="ShowFlag">随机抽40张牌</el-checkbox>
                        </template>
                    </div>
                    <div v-show="ShowFlag">
                        <template>
  ...
  export default {
    ...
    methods: {
      ...
      handleChange(){
        ...
        qingyise(val){
            if(val==true){
                this.AddCaseForm.c_options.o_chi =false;
            }
        },
        Onchi(val){
            if(val==true){
                this.AddCaseForm.c_options.o_qingyisechi =false;
            }
        },
