                    ...
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                ...
                                <el-checkbox v-model="editCaseForm.c_option.o_hongzhonglaizi" :label=1>红中癞子</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_youpaibihu" :label=1>有牌必胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_qigang" :label=1>弃杠</el-checkbox>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>抓鸟：</span>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=2>扎2鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=3>扎3鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=4>扎4鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=6>扎6鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" :label=8>扎8鸟</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_zhuaMa" label='不扎'>不扎鸟</el-radio>
                            </template>
                        </div>
                        <div>
                            <template>
                                <span>请选择玩法</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_159zhongma" :label=1 @change="ZhongMa">159中码</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bankerzhongniao" :label=1 @change="BankerZhongNiao">庄家中鸟</el-checkbox>
                            </template>
                        </div>
                        <div>
                            <template>
                                ...
                                <el-radio v-model="editCaseForm.c_option.o_zimohu" label='点炮胡'>点炮胡(可抢杠胡)</el-radio>
                            </template>
                        </div>
                        <div v-show="ShowFlag">
                            <template>
