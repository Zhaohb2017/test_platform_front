                ...
                <el-card class="box-card">
                    ...
                    <div>
                        <template>
                            ...
                            <el-radio v-model="AddCaseForm.c_options.o_fengding" :label=21>21封顶</el-radio>
                            <el-radio v-model="AddCaseForm.c_options.o_fengding" :label=42>42封顶</el-radio>
                    ...
                    <div>
                        <template>
                            <span>玩法：</span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_zhongNiaoJiaFen" :label=1 @change="ZhongNiaojiafen">中鸟加分</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_zhongNiaoFanBei" :label=2 @change="ZhongNiaofanbei">中鸟翻倍</el-checkbox>
                        </template>
                    </div>
                    ...
                    <div>
                        <template>
                            <span>玩法: </span>
                            <el-checkbox v-model="AddCaseForm.c_options.o_xianjia"         :label=1>闲家(算分)</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_yizhihua"        :label=1>一枝花</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_liuliushun"      :label=1>六六顺</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_queyise"         :label=1>缺一色</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_banbanhu"        :label=1>板板胡</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_dasixi"          :label=1>大四喜</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_bubugao"         :label=1>步步高</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_santong"         :label=1>三同</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_zhongtusixi"     :label=1>中途四喜</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_zhongtuliuliushun"     :label=1>中途六六顺</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_jiajianghu"     :label=1>假将胡</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_meiqing"     :label=1>门清</el-checkbox>
                        </template>
                    </div>
                    <div v-show="ShowFlag">
                        <template>
                            ...
                            <el-checkbox v-model="AddCaseForm.c_options.o_qieyimen" :label=1>缺一门</el-checkbox>
                            <el-checkbox v-model="AddCaseForm.c_options.o_chouforty" :label=1>随机抽40张</el-checkbox>
                        </template>
                    </div>
                      ...
                      <el-table border :data="operationList" style="width: 100%" >
                          ...
                          <el-table-column prop="card" label="牌">
                              <template slot-scope="scope">
                                  ...
                                  <el-select v-model="scope.row.in_cards" placeholder="请选择分数" v-show="operationList[scope.$index].operation === '飘分' ">
                                      <el-option
  ...
  export default {
      ...
      return {
        ...
        AddCaseForm: {
          ...
          c_options: {
              ...
              o_fengding:0,
              o_double_plus:2,
              o_zhongNiaoJiaFen:false,
              o_zhongNiaoFanBei:false,
              o_zhongNiao:0,                //中码
              o_Zhuaniao:0,                //抓鸟
              o_xianjia:false,            //闲家
              o_eighthongzhong: false,   //8红中
              o_yizhihua: false,        //一枝花
              o_liuliushun:true,       //六六顺
              o_queyise:false,        //缺一色
              o_banbanhu:true,       //板板胡
              o_dasixi:true,        //大四喜
              o_bubugao:false,     //步步高
              o_santong:false,    //三同
              o_zhongtusixi:false,//中途四息
              o_zhongtuliuliushun: false,
              o_jiajianghu:false,
              o_qieyimen:false,  //缺一门
              o_chouforty:false, //抽40张
              o_double:0,           //加倍
    ...
    methods: {
      ...
      getValue(val){
        ...
        ZhongNiaojiafen(val){
          if(val == true){
              this.AddCaseForm.c_options.o_zhongNiaoFanBei = false;
          }

      },
        ZhongNiaofanbei(val){
            if(val == true){
                this.AddCaseForm.c_options.o_zhongNiaoJiaFen = false;
            }
        },
        // 添加新的翻倍积分选项
        doublePlusNew(score){
