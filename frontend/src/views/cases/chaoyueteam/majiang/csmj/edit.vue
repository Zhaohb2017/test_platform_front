                    ...
                    <el-card class="box-card">
                        ...
                        <div>
                            <template>
                                ...
                                <el-radio v-model="editCaseForm.c_option.o_fengding" :label=21>21封顶</el-radio>
                                <el-radio v-model="editCaseForm.c_option.o_fengding" :label=42>42封顶</el-radio>
                        ...
                        <div>
                            <template>
                                <span>玩法：</span>
                                <el-checkbox v-model="editCaseForm.c_option.o_zhongNiaoJiaFen" :label=1 @change="ZhongNiaojiafen">中鸟加分</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_zhongNiaoFanBei" :label=2 @change="ZhongNiaofanbei">中鸟翻倍</el-checkbox>
                            </template>
                        </div>
                        ...
                        <div>
                            <template>
                                <span>玩法: </span>
                                <el-checkbox v-model="editCaseForm.c_option.o_xianjia"         :label=1>闲家(算分)</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_yizhihua"        :label=1>一枝花</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_liuliushun"      :label=1>六六顺</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_queyise"         :label=1>缺一色</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_banbanhu"        :label=1>板板胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_dasixi"          :label=1>大四喜</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_bubugao"         :label=1>步步高</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_santong"         :label=1>三同</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_zhongtusixi"     :label=1>中途四喜</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_zhongtuliuliushun"     :label=1>中途六六顺</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_jiajianghu"     :label=1>假将胡</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_meiqing"     :label=1>门清</el-checkbox>
                            </template>
                        </div>
                        <div v-show="ShowFlag">
                            <template>
                                ...
                                <el-checkbox v-model="editCaseForm.c_option.o_qieyimen" :label=1>缺一门</el-checkbox>
                                <el-checkbox v-model="editCaseForm.c_option.o_chouforty" :label=1>随机抽40张</el-checkbox>
                            </template>
                        </div>
                        ...
                        <el-table border :data="operationList" style="width: 100%" >
                            ...
                            <el-table-column prop="card" label="牌">
                                <template slot-scope="scope">
                                    ...
                                    <el-select v-model="scope.row.cards" placeholder="请选择" v-show="operationList[scope.$index].operation === '补杠'">
                                        <el-option
                                                v-for="item in Fill_poles"
                                                :key="item.value"
                                                :label="item.text"
                                                :value="item.value">
                                        </el-option >
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ZhongNiaojiafen(val){
                if(val == true){
                    this.editCaseForm.c_option.o_zhongNiaoFanBei = false;
                }

            },
            ZhongNiaofanbei(val){
                if(val == true){
                    this.editCaseForm.c_option.o_zhongNiaoJiaFen = false;
                }
            },
            getOption(val){
